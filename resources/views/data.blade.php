...
<section class="relative text-white pt-32 pb-20 overflow-hidden bg-gray-900">
    ...
    <div class="absolute inset-0 z-0">
        {{-- Sesuaikan 'images/bg.png' dengan gambar yang diinginkan --}}
        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ asset('images/data1.jpg') }}');"></div>
        
        {{-- Overlay gelap merata (75%) agar teks menonjol --}}
        <div class="absolute inset-0 bg-desa-dark/75"></div>
    </div>

    {{-- Efek Cahaya Blur (Z-index 0 agar berada di bawah teks tapi di atas background) --}}
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
        ...
        <h1 class="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg text-white">Data Desa Banjaran</h1>
