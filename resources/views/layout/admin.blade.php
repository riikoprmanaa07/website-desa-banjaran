...
<body class="bg-gray-100">
    ...
    <div class="fixed inset-y-0 left-0 w-64 bg-desa-dark text-white flex flex-col z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out" id="sidebar">
        <div class="flex items-center justify-between h-20 border-b border-gray-700 shrink-0 px-4">
        ...
        <nav class="mt-6 px-4 flex-1 overflow-y-auto pb-4 custom-scrollbar">
            ...
            <a href="{{ route('admin.template-surat.index') }}" class="flex items-center px-4 py-3 mb-2 rounded-lg hover:bg-gray-700 transition {{ request()->routeIs('admin.template-surat.*') ? 'bg-desa-gold text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2"/></svg>
                Template Surat
            </a>
    ...
    <div class="md:ml-64 flex flex-col min-h-screen">
        <header class="sticky top-0 z-20 bg-white shadow-sm h-20 flex items-center justify-between px-4 md:px-8">
            <div class="flex items-center">
                <button id="mobile-menu-btn" class="md:hidden mr-4 text-gray-700 hover:text-desa-gold focus:outline-none">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <p class="text-xs md:text-sm text-gray-500">@yield('page-subtitle', 'Selamat datang di Admin Panel')</p>
                </div>
            </div>

            <div class="flex items-center space-x-2 md:space-x-4">
                <a href="{{ route('home') }}" target="_blank" class="hidden md:block text-gray-600 hover:text-desa-gold transition" title="Lihat Website Publik">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative group">
                    <button class="flex items-center space-x-2 text-gray-700 hover:text-desa-gold">
                        <div class="w-8 h-8 md:w-10 md:h-10 bg-desa-gold rounded-full flex items-center justify-center text-white font-bold">
                            A
                        </div>
