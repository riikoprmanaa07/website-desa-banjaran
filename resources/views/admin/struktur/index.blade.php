...
<div class="bg-white rounded-lg shadow-md">
    ...
    @if($struktur->count() > 0)
    <div class="p-6">
        <div id="sortable-struktur" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            @foreach($struktur as $item)
            <div class="struktur-card bg-white border-2 border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition duration-300 overflow-hidden" 
                data-id="{{ $item->id }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (sortableContainer) {
        new Sortable(sortableContainer, {
            ...
            handle: '.drag-handle', // Sekarang ditarik dari area bar abu-abu saja
