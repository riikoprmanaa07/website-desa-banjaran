...
@section('page-subtitle', 'Tambahkan anggota struktur pemerintahan desa')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-800">Form Struktur Organisasi</h3>
            <p class="text-sm text-gray-500 mt-1">Isi semua data dengan lengkap dan benar</p>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.struktur.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
