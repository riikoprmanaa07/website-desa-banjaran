...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
        <div class="flex items-center justify-between">
            ...
            <div class="w-14 h-14 bg-yellow-100 rounded-full flex items-center justify-center shrink-0">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between">
                <span class="text-gray-600 w-24">Pending</span>
                <div class="flex flex-1 items-center mx-3">
                ...
                <span class="text-sm font-semibold w-10 text-right">{{ $suratStats['pending'] ?? 0 }}%</span>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-gray-600 w-24">Diproses</span>
                <div class="flex flex-1 items-center mx-3">
                    <div class="flex-1 h-3 bg-gray-200 rounded-full">
                        <div class="h-3 bg-blue-500 rounded-full" style="width: {{ $suratStats['diproses'] ?? 0 }}%"></div>
                    </div>
                </div>
                <span class="text-sm font-semibold w-10 text-right">{{ $suratStats['diproses'] ?? 0 }}%</span>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-gray-600 w-24">Selesai</span>
                <div class="flex flex-1 items-center mx-3">
                    <div class="flex-1 h-3 bg-gray-200 rounded-full">
                        <div class="h-3 bg-green-500 rounded-full" style="width: {{ $suratStats['selesai'] ?? 0 }}%"></div>
                    </div>
                </div>
                <span class="text-sm font-semibold w-10 text-right">{{ $suratStats['selesai'] ?? 0 }}%</span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between">
                <span class="text-gray-600 w-24">Laki-laki</span>
                <div class="flex flex-1 items-center mx-3">
                    <div class="flex-1 h-3 bg-gray-200 rounded-full">
                        <div class="h-3 bg-blue-500 rounded-full" style="width: {{ $genderStats['L'] ?? 0 }}%"></div>
                    </div>
                </div>
                <span class="text-sm font-semibold w-10 text-right">{{ $genderStats['L'] ?? 0 }}%</span>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-gray-600 w-24">Perempuan</span>
                <div class="flex flex-1 items-center mx-3">
                    <div class="flex-1 h-3 bg-gray-200 rounded-full">
                        <div class="h-3 bg-pink-500 rounded-full" style="width: {{ $genderStats['P'] ?? 0 }}%"></div>
                    </div>
                </div>
                <span class="text-sm font-semibold w-10 text-right">{{ $genderStats['P'] ?? 0 }}%</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="divide-y divide-gray-200">
            ...
            <div class="px-6 py-4 hover:bg-gray-50 transition">
                <div class="flex items-center justify-between">
                    ...
                    <span class="px-3 py-1 text-xs font-semibold rounded-full shrink-0
