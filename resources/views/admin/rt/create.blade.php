...
@section('page-subtitle', 'Tambahkan data Rukun Tetangga baru')
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-800">Form Data RT</h3>
            <p class="text-sm text-gray-500 mt-1">Isi semua data dengan lengkap dan benar</p>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.rt.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="rw_id" required
                        ...
                        <option value="{{ $rwItem->id }}" {{ old('rw_id') == $rwItem->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="nomor_rt" value="{{ old('nomor_rt') }}" maxlength="3" required
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3"
                        ...
                        placeholder="Alamat lengkap kantor/sekretariat RT (opsional)">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc list-inside space-y-1">
                                ...
                                <li>Pastikan memilih RW yang benar</li>
                                <li>Nomor RT harus unik dalam 1 RW</li>
                            </ul>
                        </div>
                    </div>
                </div>
