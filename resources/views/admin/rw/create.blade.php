...
@section('page-subtitle', 'Tambahkan data Rukun Warga baru')
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-800">Form Data RW</h3>
            <p class="text-sm text-gray-500 mt-1">Isi semua data dengan lengkap dan benar</p>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.rw.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nomor_rw" value="{{ old('nomor_rw') }}" maxlength="3" required
                ...
                <div>
                    ...
                    @error('no_hp')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Nomor kontak yang bisa dihubungi (opsional)</p>
                </div>
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3"
                        ...
                        placeholder="Alamat lengkap kantor/sekretariat RW (opsional)">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc list-inside space-y-1">
                                <li>Jumlah KK dan Penduduk akan dihitung otomatis dari data penduduk</li>
                                <li>Pastikan nomor RW belum ada di database</li>
                                <li>Data RT dapat ditambahkan setelah RW dibuat</li>
                            </ul>
                        </div>
                    </div>
                </div>
