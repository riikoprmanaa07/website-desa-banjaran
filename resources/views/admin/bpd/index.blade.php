...
<div class="bg-white rounded-lg shadow-md">
    ...
    @if($bpd->count() > 0)
    <div class="p-6">
        <div id="sortable-bpd" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($bpd as $item)
            <div class="bpd-card bg-white border-2 border-gray-200 rounded-lg shadow-md hover:shadow-xl transition duration-300 cursor-move" 
                data-id="{{ $item->id }}">
