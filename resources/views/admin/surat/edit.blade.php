                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_surat" value="{{ old('nomor_surat', $surat->nomor_surat) }}" required
                            ...
                            placeholder="Contoh: 001/SK/DS/2024">
                        @error('nomor_surat')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Format: XXX/YYY/ZZZ/TAHUN</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="jenis_surat" required
                            ...
                            <option value="Surat Keterangan" {{ old('jenis_surat', $surat->jenis_surat) == 'Surat Keterangan' ? 'selected' : '' }}>Surat Keterangan</option>
                            <option value="Surat Domisili" {{ old('jenis_surat', $surat->jenis_surat) == 'Surat Domisili' ? 'selected' : '' }}>Surat Domisili</option>
                            <option value="Surat Pengantar" {{ old('jenis_surat', $surat->jenis_surat) == 'Surat Pengantar' ? 'selected' : '' }}>Surat Pengantar</option>
                            <option value="SKCK" {{ old('jenis_surat', $surat->jenis_surat) == 'SKCK' ? 'selected' : '' }}>SKCK</option>
                            <option value="Surat Kematian" {{ old('jenis_surat', $surat->jenis_surat) == 'Surat Kematian' ? 'selected' : '' }}>Surat Kematian</option>
                            <option value="Surat Kelahiran" {{ old('jenis_surat', $surat->jenis_surat) == 'Surat Kelahiran' ? 'selected' : '' }}>Surat Kelahiran</option>
                            <option value="Surat Usaha" {{ old('jenis_surat', $surat->jenis_surat) == 'Surat Usaha' ? 'selected' : '' }}>Surat Usaha</option>
                            <option value="Surat Tidak Mampu" {{ old('jenis_surat', $surat->jenis_surat) == 'Surat Tidak Mampu' ? 'selected' : '' }}>Surat Tidak Mampu</option>
                            <option value="Lainnya" {{ old('jenis_surat', $surat->jenis_surat) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                        @error('jenis_surat')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_surat" value="{{ old('tanggal_surat', $surat->tanggal_surat->format('Y-m-d')) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="penandatangan" value="{{ old('penandatangan', $surat->penandatangan) }}" required
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <select name="penduduk_id" required
                            ...
                            <option value="{{ $p->id }}" {{ old('penduduk_id', $surat->penduduk_id) == $p->id ? 'selected' : '' }}>
                                {{ $p->nama }} - NIK: {{ $p->nik }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <p class="text-sm font-medium text-gray-700 mb-2">Data Pemohon Saat Ini:</p>
                        <div class="grid grid-cols-2 gap-3 text-sm">
                            <div>
                                <span class="text-gray-600">NIK:</span>
                                <span class="text-gray-900 font-medium ml-2">{{ $surat->penduduk->nik }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">Nama:</span>
                                <span class="text-gray-900 font-medium ml-2">{{ $surat->penduduk->nama }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">Alamat:</span>
                                <span class="text-gray-900 font-medium ml-2">{{ $surat->penduduk->alamat }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">RT/RW:</span>
                                <span class="text-gray-900 font-medium ml-2">{{ $surat->penduduk->rt }}/{{ $surat->penduduk->rw }}</span>
                            </div>
                        </div>
                    </div>
