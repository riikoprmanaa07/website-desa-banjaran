...
<section class="relative text-white pt-32 pb-20 overflow-hidden bg-gray-900">
    ...
    <div class="absolute inset-0 z-0">
        {{-- Ganti 'images/bg.png' dengan gambar yang sesuai (misal: foto kegiatan desa) --}}
        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ asset('images/berita.jpg') }}');"></div>
        
        {{-- Overlay gelap 75% agar teks putih tetap terbaca jelas --}}
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
        ...
        {{-- Tambahan drop-shadow agar teks lebih tajam dan menonjol --}}
        <h1 class="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg text-white">Berita Terkini</h1>
        
        {{-- Warna teks dicerahkan menjadi gray-200 dan ditambahkan drop-shadow --}}
